 ...
 * For instance, this concerns Intel's compiler (ICC), which performs such optimizer by default unless
...
//
// TODO Opportunities for optimizer: better root finding algo, better stopping criterion, better
